...
export const authorizeUser = async (config: Configuration, accountId: string): Promise<{
    status: string;
    ...
    try {
        ...
        const SCOPES = ["user_info","read_payment_method","write_payment_method","read_kyc","verify_kyc"]
